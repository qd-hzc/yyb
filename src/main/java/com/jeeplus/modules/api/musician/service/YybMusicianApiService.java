 ...
 */
package com.jeeplus.modules.api.musician.service;
...
public class YybMusicianApiService extends CrudService<YybMusicianApiMapper, YybMusician> {

	@Autowired
	private YybMusicianAlbumMapper yybMusicianAlbumMapper;

		@Autowired
	private YybMusicianApiMapper yybMusicianMapper;
