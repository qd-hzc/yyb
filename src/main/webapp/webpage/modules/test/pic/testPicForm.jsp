...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="testPic" class="form-horizontal">
		<form:hidden path="id"/>	
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:fileUpload fileNumLimit="1" path="pic"  value="${testPic.pic}" type="file" uploadPath="/test/pic/testPic"/>
					</td>
				</tr>
				<tr>
