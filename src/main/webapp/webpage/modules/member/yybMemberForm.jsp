		...
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<sys:fileUpload type="image" fileNumLimit="1" path="idCardAttach"  value="${yybMember.idCardAttach}" uploadPath="/member/yybMember"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35">
						<sys:fileUpload type="image" fileNumLimit="1" path="orgCodeAttach"  value="${yybMember.orgCodeAttach}"  uploadPath="/member/yybMember"/>
					</td>
